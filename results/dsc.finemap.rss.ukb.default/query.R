...
susie_out = dscrutils::dscquery(output_dir,
                                targets = c("small_data.dataset","sim_gaussian",
                                            ...
                                            "method_susie","method_susie.lamb",
...
finemap_out = dscrutils::dscquery(output_dir,
                                  targets = c("small_data.dataset","sim_gaussian",
                                              "sim_gaussian.meta", "sim_gaussian.n_signal",
                                              "method_finemap.args", "method_finemap.ld_method",
...
finemapv3_out = dscrutils::dscquery(output_dir,
                                  targets = c("small_data.dataset","sim_gaussian",
                                              "sim_gaussian.meta", "sim_gaussian.n_signal",
                                              "method_finemap_v3.args", "method_finemap_v3.ld_method",
                                              "method_finemap_v3.add_z", "method_finemap_v3.DSC_TIME",
