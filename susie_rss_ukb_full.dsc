...
DSC:
  ...
  run:
    ...
    large_region: full_data * sim_gaussian * get_sumstats * (method_susie_simple * score_susie, finemap_simple * score_finemap, finemap_v3_simple * score_finemapv3, caviar_simple * score_caviar)
